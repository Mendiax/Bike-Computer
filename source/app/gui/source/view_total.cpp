...
void View_Total::render(void)
{
    ...
    creator->add_value("time:%.1f",(5+5),&this->data.sensors.total_time_ridden, frame_time, Align::LEFT);
    creator->add_value("dist:%.1f",(5+5),&this->data.sensors.total_distance_ridden, frame_dist, Align::LEFT);
}
// #------------------------------#
