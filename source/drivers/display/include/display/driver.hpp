...
#define COLOR_BLUE           (display::DisplayColor){0x0, 0x0, 0xF}
#define COLOR_RED            (display::DisplayColor){0xF, 0x0, 0x0}
#define COLOR_GREEN          (display::DisplayColor){0x0, 0xF, 0x0}
