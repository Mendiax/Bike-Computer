...
//     def __init__(self):
//         for f in this->gears["front"]:
//             for r in this->gears["rear"]:
//                 this->gear_ratios.append(f/r)
//         print(this->gear_ratios)
//         # input
//         this->accel = 0.0 # km/h/s
//         this->speed = 0.0 # km/h
//         this->cadence = 0.0 # rpm
//         this->gear = 6

//         # constants
//         this->__accel_up = 5
//         this->__cadence_min = 80
//         this->__cadence_max = 90
